...
class Data:
    ...
    def __init__(self, data_dir="data/NELL/", reverse=False):
    ...
    def get_lattice_bytes_dic(self, data_dir):
        ...
        relation_to_describ_dir = data_dir + "/relation_to_surface_name_all.txt"
        relation_dis_dic = {}
        Ws = []
    ...
    def load_relation_id_mask_matrix(self, data_dir,Byte_dic):
        ...
        with open(relation_to_describ_dir, "r", encoding="utf-8") as fr:
            for line in fr.readlines():
                ...
                if len(all_bytes_n)>90:
                    all_bytes_n=all_bytes_n[:90]
                else:
                    all_bytes_n=all_bytes_n+["<unk>"]*(90-len(all_bytes_n))
