...
class Experiment:
    ...
    def evaluate(self, model, mode,entity_sets2ids,renaltion_char_id,lattice_rel):
        test_candidates = json.load(open("data/NELL/" + mode + "_candidates.json"))
        ...
        for it in range(1, self.num_iterations + 1):
            ...
            with torch.no_grad():
                ...
                fw.write("mrr:" + str(mrr) + "\t" + "hit10:" + str(hit10) + "\t" + "hit5:" + str(
                    hit5) + "\t" + "hit1:" + str(hit1) + "\n")
                fw.flush()
                checkpoint_path = 'nell_checkpoints/'
...
if __name__ == '__main__':
    ...
    parser.add_argument("--dataset", type=str, default="NELL", nargs="?",
                        help="Which dataset to use: FB15k, FB15k-237, WN18 or WN18RR.")
    parser.add_argument("--num_iterations", type=int, default=200, nargs="?",  # 500
    ...
    parser.add_argument("--label_smoothing", type=float, default=0.0, nargs="?",
